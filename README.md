...
itself. On macOS the live page carrying your browser's TikTok login goes first,
and is fetched a second time after a few seconds — before the slower routes —
when the first fetch read that login but the page carried no address. Being signed in to TikTok in Chrome or Safari helps but is usually not
